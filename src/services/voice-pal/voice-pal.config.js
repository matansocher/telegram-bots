...
const TIKTOK_SUMMARY_PROMPT = 'You are a helpful assistant. You will be provided with a transcription of a video from the user, the includes all the sentences in the video and the timestamp.' +
...
const NOT_FOUND_TIKTOK_VIDEO_MESSAGE = 'I am having trouble finding the tiktok video you shared. please send me a link in this format - https://www.tiktok.com/@{username}/video/xxxxxxxxxxxx';

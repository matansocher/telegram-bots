...
import voicePalUtils from './voice-pal.utils';
import imgurService from '../imgur.service';
import googleTranslateService from '../google-translate.service';
import openaiService from '../openai/openai.service';
import socialMediaDownloaderService from '../social-media-downloader.service';
import userSelectionService from './user-selections.service';
import youtubeTranscriptService from '../youtube-transcript.service';
import mongoService from '../mongo/voice-pal/mongo.service';
import generalBotService from '../../telegram-bots/general-bot.service';
import * as utilsService from '../utils.service';
import messageLoaderService from '../../telegram-bots/message-loader.service';
import LoggerService from '../logger.service';
const logger = new LoggerService(module.filename);

export default class VoicePalService {
    private readonly bot: any;
    private readonly chatId: any;

...
const NOTEBOOK_BOT_ACTIONS_TO_SAVE = {
    NEW_LIST: {
...
const NOTEBOOK_BOT_ACTIONS_TO_HANDLE = {
    SHOW_LIST_ITEMS: {
...
const NOTEBOOK_LIST_ITEM_ACTIONS = {
...
module.exports = {
    ...
    NOTEBOOK_BOT_OPTIONS,
    NOTEBOOK_BOT_ACTIONS,
    NOTEBOOK_BOT_ACTIONS_TO_SAVE,
    NOTEBOOK_BOT_ACTIONS_TO_HANDLE,
